      ...
      <div className="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
          ...
          <section className="rounded-3xl border border-slate-800 bg-slate-900/95 p-6 shadow-sm shadow-black/20">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-semibold text-white">{filledMetricsCount} of 4 metrics recorded</h3>
              </div>
              <p className="rounded-3xl bg-slate-800 px-3 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-slate-300">
                Updated {lastUpdated}
              </p>
            </div>
        ...
        <aside className="space-y-6">
          <section className="rounded-3xl border border-slate-800 bg-slate-900/95 p-6 shadow-sm shadow-black/20">
            ...
            <h3 className="mt-3 text-2xl font-semibold text-white">A simple health snapshot</h3>
            <p className="mt-4 text-sm leading-6 text-slate-400">
          ...
          <section className="rounded-3xl border border-slate-800 bg-slate-900/95 p-6 shadow-sm shadow-black/20">
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500">Guidance</p>
